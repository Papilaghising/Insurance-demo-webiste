...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-cyan-50 px-4 py-12 overflow-hidden">
      ...
      <Link
        href="/"
        className="absolute top-8 left-8 flex items-center text-gray-600 hover:text-indigo-600 transition-all duration-300 hover:scale-105 z-10"
      >
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Login form */}
        <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl shadow-indigo-500/10 border border-white/20">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) => setEmail(e.target.value)}
                  required
                  className="pl-4 pr-4 py-3 bg-gray-50/50 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 hover:bg-gray-50"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) => setPassword(e.target.value)}
                  required
                  className="pl-4 pr-12 py-3 bg-gray-50/50 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 hover:bg-gray-50"
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all duration-300 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {isLoading ? (
            ...
            <div className="text-center">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center w-full py-3 px-4 border-2 border-indigo-200 text-indigo-600 font-semibold rounded-xl hover:bg-indigo-50 hover:border-indigo-300 transition-all duration-300 hover:scale-105 active:scale-95"
              >
